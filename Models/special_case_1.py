...
# Baseline TT used in your main model (Basaria anchor baseline)
TT_BASELINE = 622.0

# Exposure scaling anchor (Basaria: 1.0 mg/day has day-21 AUC ≈ 238 ng·24h/mL)
AUC21_AT_1MG = 238.0

# PK scenarios (as you used)
SCENARIOS = {
...
def main():
    ...
    combined = observed_summary.merge(model_summary, on="case_id", how="left")
