...
csv_1C = os.path.join(OUTPUT_DIR, "lgd_goal1C_inversion_implied_exposure_bands_hill.csv")
csv_all = os.path.join(OUTPUT_DIR, "lgd_goal1ABC_combined_results_hill.csv")
csv_pd = os.path.join(OUTPUT_DIR, "lgd_goal1_pd_draws_used_hill.csv")
